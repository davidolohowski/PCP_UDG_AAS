...
# chain for model 1
res <- readRDS('data/v12acs_res/v12acs-pcp-2022-07-21-seed-513268-100k.RDS')

# chain for model 2
res_col <- readRDS('data/v12acs_res/v12acs-pcp-col-2022-07-21-seed-513268-100k.RDS')
...
prior_df_ncol <- data.frame(value = c(seq(min(ncol_mod$b0), max(ncol_mod$b0), length= 100), 
                            ...
                            density = c(dlnorm(seq(min(ncol_mod$b0), max(ncol_mod$b0), length= 100), 4.017537, 0.25),
                                        ...
                                        dlnorm(seq(min(ncol_mod$N1), max(ncol_mod$N1), length= 100), log(10), 0.25),
                                        dlnorm(seq(min(ncol_mod$n2), max(ncol_mod$n2), length= 100), log(0.5), 0.5),
                                        dlnorm(seq(min(ncol_mod$N2), max(ncol_mod$N2), length= 100), log(40), 0.25),
                                        dlnorm(seq(min(ncol_mod$R1), max(ncol_mod$R1), length= 100), 4.4 - log(4300), 0.25),
                                        dlnorm(seq(min(ncol_mod$R2), max(ncol_mod$R2), length= 100), 5.5 - log(4300), 0.25)),
...
prior_df_col <- data.frame(value = c(seq(min(col_mod$b0), max(col_mod$b0), length= 100), 
                           ...
                           density = c(dlnorm(seq(min(col_mod$b0), max(col_mod$b0), length= 100), 4.017537, 0.25),
                                       ...
                                       dlnorm(seq(min(col_mod$N1), max(col_mod$N1), length= 100), log(10), 0.25),
                                       dlnorm(seq(min(col_mod$n2), max(col_mod$n2), length= 100), log(0.5), 0.5),
                                       dlnorm(seq(min(col_mod$N2), max(col_mod$N2), length= 100), log(40), 0.25),
                                       dlnorm(seq(min(col_mod$R1), max(col_mod$R1), length= 100), 4.4 - log(4300), 0.25),
                                       dlnorm(seq(min(col_mod$R2), max(col_mod$R2), length= 100), 5.5 - log(4300), 0.25),
...
tikz(file = "v12acs_post_ncol.tex", standAlone=T, width = 9, height = 9)
...
dev.off()
system('pdflatex v12acs_post_ncol.tex')

tikz(file = "v12acs_post_col.tex", standAlone=T, width = 9, height = 9)
...
dev.off()
system('pdflatex v12acs_post_col.tex')

U <- data.frame(x = 3840, y = 2633)/4300
...
tikz(file = "v12acs_U_post_ncol.tex", standAlone=T, width = 9, height = 3)
...
dev.off()
system('pdflatex v12acs_U_post_ncol.tex')
...
tikz(file = "v12acs_U_post_col.tex", standAlone=T, width = 6, height = 6)
...
dev.off()
system('pdflatex v12acs_U_post_col.tex')
...
tikz(file = "v12acs_model1_res.tex", standAlone=T, width = 5, height = 4.5*5/6)
...
dev.off()
system('pdflatex v12acs_model1_res.tex')

tikz(file = "v12acs_model2_res.tex", standAlone=T, width = 5, height = 4.5*5/6)
ggplot(X_c, aes(x, y)) + stat_density_2d(aes(fill = ..density..), 
  ...
  theme_minimal() + geom_point(data = pts, aes(x,y), size = 0.1)
dev.off()
system('pdflatex v12acs_model2_res.tex')

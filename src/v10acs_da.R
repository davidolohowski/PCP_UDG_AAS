...
#fixed parameters for normal elliptical galaxies
...
# R hat statistics for Model 1 and Model 2
PSRF_ncol <- stable.GR(prob_ncol, multivariate = F)
PSRF_col <- stable.GR(prob_col, multivariate = F)

# posterior density plots for fixed dimensional parameters
# Model 1
...
# Posterior densities for parameters of UDGs
...
# density and probability plots for X_c
ncol_dat <- res[[1]][-c(1:10000)]
col_dat <- res_col[[1]][-c(1:10000)]
...
# Performance metrics comparison between Model 1 and Model 2
...
# 2d Density plots of X_c under Model 1 and Model 2 

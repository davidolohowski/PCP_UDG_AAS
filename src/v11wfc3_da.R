...
# chain for model 1
res <- readRDS('data/v11wfc3_res/v11wfc3-pcp-2022-07-29-seed-632178-100k.RDS')
# chain for model 2
res_col <- readRDS('data/v11wfc3_res/v11wfc3-pcp-col-2022-07-29-seed-632178-100k.RDS')
...
tikz(file = "v11wfc_post_ncol.tex", standAlone=T, width = 6, height = 3)
...
dev.off()
system('pdflatex v11wfc_post_ncol.tex')

tikz(file = "v11wfc_post_col.tex", standAlone=T, width = 9, height = 3)
